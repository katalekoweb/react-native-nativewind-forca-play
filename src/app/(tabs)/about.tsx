...
const Home = () => {
  ...
  const handleOpenMail = () => {
    Linking.openURL(
      `mailto:juliofeli78@gmai.com?subject=${subject}&body=${body}`,
    );
  };
        ...
        <Section title="Formas de Contacto">
          <Card>
            <View className="gap-1 py-2">
              ...
              <Text
                className="font-regular text-primary underline text-md"
                onPress={handleOpenLink}
              >
                https://facebook.com/juliaokataleko
              </Text>
            </View>

            <View className="gap-1 py-2">
              <Text className="font-regular text-text text-md">Instagram</Text>
              <Text className="font-regular text-primary underline text-md">
                https://facebook.com/juliaokataleko
              </Text>
            </View>
